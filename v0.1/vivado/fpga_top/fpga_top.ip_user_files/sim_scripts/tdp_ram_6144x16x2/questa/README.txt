...
#
# Generated by export_simulation on Wed Dec 04 10:10:07 +0100 2019
#
################################################################################
...
'-reset_run' switch to the './tdp_ram_6144x16x2.sh' script.

./tdp_ram_6144x16x2.sh -reset_run
...
./tdp_ram_6144x16x2.sh -noclean_files

For more information on the script, please type './tdp_ram_6144x16x2.sh -help'.
