...
#
# Generated by export_simulation on Wed Dec 04 10:09:55 +0100 2019
#
################################################################################
...
'-reset_run' switch to the './sdp_ram_16x32.sh' script.

./sdp_ram_16x32.sh -reset_run
...
./sdp_ram_16x32.sh -noclean_files

For more information on the script, please type './sdp_ram_16x32.sh -help'.
