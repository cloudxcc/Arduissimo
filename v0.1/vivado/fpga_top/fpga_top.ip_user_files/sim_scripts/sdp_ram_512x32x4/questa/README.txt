...
#
# Generated by export_simulation on Wed Dec 04 10:10:03 +0100 2019
#
################################################################################
...
'-reset_run' switch to the './sdp_ram_512x32x4.sh' script.

./sdp_ram_512x32x4.sh -reset_run
...
./sdp_ram_512x32x4.sh -noclean_files

For more information on the script, please type './sdp_ram_512x32x4.sh -help'.
