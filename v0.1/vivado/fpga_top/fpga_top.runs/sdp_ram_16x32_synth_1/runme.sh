...
HD_PWD='D:/projects/arduissimo/release/v0.1/vivado/fpga_top/fpga_top.runs/sdp_ram_16x32_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log sdp_ram_16x32.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source sdp_ram_16x32.tcl
