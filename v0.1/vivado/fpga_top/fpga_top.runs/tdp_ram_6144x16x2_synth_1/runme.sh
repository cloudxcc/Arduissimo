...
HD_PWD='D:/projects/arduissimo/release/v0.1/vivado/fpga_top/fpga_top.runs/tdp_ram_6144x16x2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tdp_ram_6144x16x2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tdp_ram_6144x16x2.tcl
